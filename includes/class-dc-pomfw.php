...
class Dc_Pomfw {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Dc_Pomfw_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Dc_Pomfw_Loader. Orchestrates the hooks of the plugin.
	 * - Dc_Pomfw_i18n. Defines internationalization functionality.
	 * - Dc_Pomfw_Admin. Defines all hooks for the admin area.
	 * - Dc_Pomfw_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dc-pomfw-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dc-pomfw-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-dc-pomfw-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-dc-pomfw-public.php';

		$this->loader = new Dc_Pomfw_Loader();
	 ...
	 *
	 * Uses the Dc_Pomfw_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Dc_Pomfw_Loader    Orchestrates the hooks of the plugin.
	 */
